...
export default function FileUpload({ value, onChange, error, helper, accept = '.jpg,.jpeg,.png', fileTypesLabel }) {
  const { t } = useTranslation()
  const inputRef = useRef(null)
  const resolvedFileTypesLabel = fileTypesLabel ?? t('fileUpload.defaultTypes')
      ...
      <div className={styles.wrapper}>
        <div className={styles.fileDisplay}>
          ...
          <div className={styles.fileActions}>
            <button type="button" className={styles.actionBtn} onClick={handleDownload} title={t('fileUpload.download')}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <button type="button" className={styles.actionBtn} onClick={handleRemove} title={t('fileUpload.remove')}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  return (
    <div className={styles.wrapper}>
      ...
      >
        ...
        />
        <span className={styles.dropText}>{t('fileUpload.dropText')}</span>
        <span className={styles.dropSubtext}>{resolvedFileTypesLabel}</span>
        <span className={styles.uploadLink}>
          {t('fileUpload.uploadLink')}
