...
export default function InstanceConnect({ onConnect }) {
  ...
  const [inputValue, setInputValue] = useState(state.instanceId ? String(state.instanceId) : '')
  ...
  const handleChange = (val) => {
    ...
    setError(null)
    if (numeric) {
      dispatch({ type: 'SET_INSTANCE', payload: { id: Number(numeric), name: null } })
    } else {
          ...
          <div className={styles.card}>
            ...
            <div className={styles.titleGroup}>
              ...
              <p className={styles.description}>
                Ingresa el Instance ID de tu comunidad para vincular el configurador del sitio de empleos.
              </p>
            </div>
            ...
            <div className={styles.selectWrapper}>
              <Input
                ...
                helper="Si no lo tienes, consulta con tu administrador de Humand."
                error={error}
